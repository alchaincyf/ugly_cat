...
const scoreDescriptions = [
  ...
  { minScore: 7.5, maxScore: 8.0, description: "你这猫颜值丑过了{percent}%的猫，看来'丑得别具一格'这个词是为它发���的。" },
